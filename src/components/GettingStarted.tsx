...
export default ({ template, className, templateName, runLabel, logo }: Props) => {
    ...
    return (<div className={cn("flex flex-col max-w-3xl", className)}>
                        ...
                        <div className="bg-white dark:bg-gray-800 px-4 py-4 mr-4 mb-4 rounded-lg shadow-lg text-center items-center justify-center hover:shadow-2xl dark:border-2 dark:border-pink-600 dark:hover:border-blue-600"
                            ...
                            <div className="text-center font-extrabold flex items-center justify-center mb-2">
                                <div className="text-4xl text-blue-400 my-3">
                                    {logo ?? <NextLogo className="size-12 text-black" />}
                                </div>
                            </div>
                            <div className="text-xl font-medium text-gray-700 dark:text-gray-300">{templateName ?? "Next.js"}</div>
        ...
        <h4 className="py-6 text-center text-xl">{runLabel ?? "Run .NET and Next.js"}</h4>
